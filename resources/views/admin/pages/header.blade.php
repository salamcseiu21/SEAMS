    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/admin-panel')}}">SEAMS Admin</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <li></li>
                 ...
                 <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" data-hover="dropdown">
                        <i class="fa fa-plus"></i> Upload <i class="fa fa-caret-down"></i> 
                    </a>
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="{{url('/upload-dayend')}}">
                                Day End Archive
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="{{url('/upload-markset-summary')}}">
                              Market Summary
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="{{url('/upload-share-holding')}}">
                              Share holding
                            </a>
                        </li>
                        <li class="divider"></li>
